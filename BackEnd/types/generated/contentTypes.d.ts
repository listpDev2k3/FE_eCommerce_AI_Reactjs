...
export interface ApiProductsBookProductsBook
  ...
  info: {
    displayName: 'ProductsBook';
    pluralName: 'products-books';
    singularName: 'products-book';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    >;
    id_product: Schema.Attribute.String & Schema.Attribute.Required;
    language: Schema.Attribute.Enumeration<
      ['Ti\u1EBFng Vi\u1EC7t ', 'English ', 'French']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
